...
namespace RoseMountainBandWebsite.Controllers
{
    public class MessagesController : Controller
    {
        ...
        */
        ...
        public async Task<IActionResult> Create([Bind("Id,SubmitterName,SubmitterEmail,SubmittedText")] Message message)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SubmitterName,SubmuitterEmail,SubmittedText")] Message message)
        {
            if (id != message.Id)
            {
                return NotFound();
